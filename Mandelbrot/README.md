...
| номер запуска | затраченное время, секунд | погрешность, секунд |
|---------------|---------------------------|---------------------|
| 1             | 168.3                     | 0.5                 |
| 2             | 167.1                     | 0.4                 |
| 3             | 168.0                     | 0.4                 |
...
| реализация | время на 50 запусков, сек | время на один запуск, ms | погрешность времени на один запуск, ms |
|------------|---------------------------|--------------------------|----------------------------------------|
| скалярная  | 167.80                    | 3356                     | 9                                      |
| векторная  | 22.72                     | 454.4                    | 0.7                                    |
