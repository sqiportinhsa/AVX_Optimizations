...
| кол-во повторений | clang:  время | clang:  погрешность | автор:  время | автор:  погрешность |
|-------------------|---------------|---------------------|---------------|---------------------|
